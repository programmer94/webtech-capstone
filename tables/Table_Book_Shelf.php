...
<html>
    <head>
        ...
        <script type="text/javascript">
            function redirectToAddBookshelf() {
                window.location.replace("../NewBookshelfEntry.php");
            }
        </script>
    </head>
    <body>
        ...
        ?><!-- end PHP script -->
        <button type="button" OnClick=redirectToAddBookshelf()>Add Bookshelf</button>
        <h1>Book Shelf DB</h1>
        <table>
            <tr>
            	<th>ISBN</th>
